...
#### `Muleta\Traits\Models\Attributable`
...
**Facilitador Attributes** has been specially made for Eloquent and simplicity has been taken very serious as in any other Laravel related aspect. To add EAV functionality to your Eloquent model just use the `\Muleta\Traits\Models\Attributable` trait like this:
