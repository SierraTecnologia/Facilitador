# Support\Discovers\Reliese Laravel
...
Support\Discovers\Reliese Laravel is a collection of Laravel Components which aim is 
...
'providers' => [
    ...
    Support\Discovers\Reliese\Coders\CodersServiceProvider::class,
],
// ...
```
...
public function register()
{
    if ($this->app->environment() == 'local') {
        $this->app->register(\Support\Discovers\Reliese\Coders\CodersServiceProvider::class);
    }
}
```
