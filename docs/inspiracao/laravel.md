# Support\Components\Database Laravel
...
Support\Components\Database Laravel is a collection of Laravel Components which aim is 
...
'providers' => [
    ...
    Support\Components\Database\Coders\CodersServiceProvider::class,
],
// ...
```
...
public function register()
{
    if ($this->app->environment() == 'local') {
        $this->app->register(\Support\Components\Database\Coders\CodersServiceProvider::class);
    }
}
```
