# Support\Coder\Discovers\Reliese Laravel
...
Support\Coder\Discovers\Reliese Laravel is a collection of Laravel Components which aim is 
...
'providers' => [
    ...
    Support\Coder\Discovers\Reliese\Coders\CodersServiceProvider::class,
],
// ...
```
...
public function register()
{
    if ($this->app->environment() == 'local') {
        $this->app->register(\Support\Coder\Discovers\Reliese\Coders\CodersServiceProvider::class);
    }
}
```
