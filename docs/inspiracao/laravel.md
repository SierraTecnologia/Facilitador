...
Support\Reliese Laravel is a collection of Laravel Components which aim is 
...
'providers' => [
    ...
    Support\Reliese\Coders\CodersServiceProvider::class,
],
// ...
```
...
public function register()
{
    if ($this->app->environment() == 'local') {
        $this->app->register(\Support\Reliese\Coders\CodersServiceProvider::class);
    }
}
```
