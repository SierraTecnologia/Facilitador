# Facilitador\Support\Reliese Laravel
...
Facilitador\Support\Reliese Laravel is a collection of Laravel Components which aim is 
...
'providers' => [
    ...
    Facilitador\Support\Reliese\Coders\CodersServiceProvider::class,
],
// ...
```
...
public function register()
{
    if ($this->app->environment() == 'local') {
        $this->app->register(\Facilitador\Support\Reliese\Coders\CodersServiceProvider::class);
    }
}
```
