...
if (!function_exists('form_maker_table')) {
    ...
    {
        return app('Datatable')->fromTable($table, $columns, $class, $view, $reformatted, $populated, $idAndTimestamps);
    }
}
...
if (!function_exists('form_maker_object')) {
    ...
    {
        return app('Datatable')->fromObject($object, $columns, $view, $class, $populated, $reformatted, $idAndTimestamps);
    }
}
...
if (!function_exists('form_maker_array')) {
    ...
    {
        return app('Datatable')->fromArray($array, $columns, $view, $class, $populated, $reformatted, $idAndTimestamps);
    }
}
...
if (!function_exists('form_maker_columns')) {
    ...
    {
        return app('Datatable')->getTableColumns($table);
    }
}
