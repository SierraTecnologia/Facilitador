...
if (!function_exists('form_maker_table')) {
    ...
    {
        return app('Display')->fromTable($table, $columns, $class, $view, $reformatted, $populated, $idAndTimestamps);
    }
}
...
if (!function_exists('form_maker_object')) {
    ...
    {
        return app('Display')->fromObject($object, $columns, $view, $class, $populated, $reformatted, $idAndTimestamps);
    }
}
...
if (!function_exists('form_maker_array')) {
    ...
    {
        return app('Display')->fromArray($array, $columns, $view, $class, $populated, $reformatted, $idAndTimestamps);
    }
}
...
if (!function_exists('form_maker_columns')) {
    ...
    {
        return app('Display')->getTableColumns($table);
    }
}
