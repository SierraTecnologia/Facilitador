...
class ControllersCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'siravel:facilitador:controllers';
     ...
     * @var string
     */
    protected $description = 'Publish all the controllers from Facilitador.';
    ...
    public function handle()
    {
        ...
        $this->info('Published Facilitador controllers!');
    }
    ...
    {
        return $this->filesystem->get(base_path('/vendor/tcg/facilitador/stubs/'.$this->stub));
    }
    ...
    protected function generateContent(string $stub, $class): string
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'Facilitador\\Http\\Controllers\\'.$class,
            $content
        );
