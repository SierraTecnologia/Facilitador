...
use Facilitador\Support\Reliese\Meta\MySql\Schema as MySqlSchema;
use Facilitador\Support\Reliese\Meta\Sqlite\Schema as SqliteSchema;
...
class SchemaManager implements IteratorAggregate
{
    ...
    /**
     * @var \Facilitador\Support\Reliese\Meta\Schema[]
     */
    protected $schemas = [];
