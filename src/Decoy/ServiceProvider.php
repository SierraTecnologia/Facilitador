...
namespace Facilitador\Decoy;

use App;
use Config;
use Former\Former;
use Facilitador\Decoy\Observers\Validation;
...
class ServiceProvider extends BaseServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->app['events']->listen('eloquent.*',
            'Facilitador\Decoy\Observers\ModelCallbacks');
        ...
        // before being saved.
        $this->app['events']->listen('eloquent.*',
            'Facilitador\Decoy\Observers\Changes');
    }
    ...
    protected function configureFormer()
    {
        ...
        $this->app['former.dispatcher']->addRepository('Facilitador\Decoy\Fields\\');
    }
    ...
    protected function delegateAdminObservers()
    {
        $this->app['events']->listen('eloquent.saving:*',
            'Facilitador\Decoy\Observers\Localize');
        $this->app['events']->listen('eloquent.saving:*',
            'Facilitador\Decoy\Observers\Encoding@onSaving');
        $this->app['events']->listen('eloquent.saved:*',
            'Facilitador\Decoy\Observers\ManyToManyChecklist');
        $this->app['events']->listen('eloquent.deleted:*',
            'Facilitador\Decoy\Observers\Encoding@onDeleted');
        $this->app['events']->listen('decoy::model.validating:*',
            'Facilitador\Decoy\Observers\ValidateExistingFiles@onValidating');
    }
