...
class Helpers
{
    ...
    public function modelForController($controller)
    {
        ...
        $model = str_replace('Facilitador\Decoy\Controllers',
            'Facilitador\Decoy\Models',
            $controller,
            $is_decoy);
    ...
    {
        // Swap out the namespace if decoy
        $controller = str_replace('Facilitador\Decoy\Models', 'Facilitador\Decoy\Controllers', $model, $is_decoy);
