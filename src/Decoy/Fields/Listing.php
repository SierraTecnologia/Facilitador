...
namespace Facilitador\Decoy\Fields;
...
class Listing extends Field
{
     ...
     *
     * @var Facilitador\Decoy\Controller\Base
     */
    private $controller;
     ...
     *
     * @param  Facilitador\Decoy\Controllers\Base $controller
     * @param  LengthAwarePaginator         $items
     * @return Facilitador\Decoy\Field\Listing
     */
     ...
     *
     * @param  Facilitador\Decoy\Controllers\Base | string $controller
    ...
    public function controller($controller)
    {
        ...
        if (is_string($controller)
            ...
            && is_subclass_of($controller, 'Facilitador\Decoy\Controllers\Base')) {
        ...
        // Or, validate a passed controller instance
            ...
            && is_a($controller, 'Facilitador\Decoy\Controllers\Base')) {
     ...
     *
     * @param  Facilitador\Decoy\Controller\Base $controller A controller instance
