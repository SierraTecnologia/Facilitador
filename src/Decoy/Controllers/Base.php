...
namespace Facilitador\Decoy\Controllers;
...
use Facilitador\Decoy\Input\Sidebar;
use Facilitador\Decoy\Fields\Listing;
use Facilitador\Decoy\Input\Localize;
use Facilitador\Decoy\Input\Position;
use Illuminate\Routing\Controller;
use Facilitador\Decoy\Input\NestedModels;
use Facilitador\Decoy\Input\ModelValidator;
use Facilitador\Decoy\Models\Base as BaseModel;
use Facilitador\Decoy\Exceptions\ValidationFail;
...
class Base extends Controller
{
    ...
    public function controllerName($class = null)
    {
        ...
        $name = preg_replace('#^('.preg_quote('Facilitador\Decoy\Controllers\\')
    ...
    public function detailPath($class)
    {
        ...
        $path = str_replace('Facilitador\Decoy\Controllers\\', '', $class, $is_decoy);
     ...
     *
     * @param  Facilitador\Decoy\Model\Base|string $title The model instance that is
    ...
    protected function successMessage($input = '', $verb = 'saved')
    {
        ...
        $title = $input;
        if (is_a($input, '\Facilitador\Decoy\Models\Base')) {
        ...
        if ($verb == 'duplicated' && is_a($input, '\Facilitador\Decoy\Models\Base') && !empty($input->locale)) {
