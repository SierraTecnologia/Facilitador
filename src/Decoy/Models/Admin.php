...
namespace Facilitador\Decoy\Models;
...
use Facilitador\Decoy\Auth\AuthInterface;
use Facilitador\Decoy\Notifications\ResetPassword;
    ...
    CanResetPasswordContract
{
    ...
    {
        return DecoyURL::action('Facilitador\Decoy\Controllers\Admins@edit', $this->id);
    }
    ...
    public static function getPermissionOptions($admin = null)
    {
        ...
        $controllers[] = 'Facilitador\Decoy\Controllers\Admins';
        $controllers[] = 'Facilitador\Decoy\Controllers\Changes';
        $controllers[] = 'Facilitador\Decoy\Controllers\Elements';
        $controllers[] = 'Facilitador\Decoy\Controllers\RedirectRules';
