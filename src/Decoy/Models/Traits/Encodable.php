...
namespace Facilitador\Decoy\Models\Traits;
...
trait Encodable
{
    ...
    {
        return $this->morphMany('Facilitador\Decoy\Models\Encoding', 'encodable');
    }
    ...
    {
        $key = is_a($this, 'Facilitador\Decoy\Models\Element')
