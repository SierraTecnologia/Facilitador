...
namespace Facilitador\Decoy\Input\EncodingProviders;

use Config;
use Request;
use Illuminate\Support\Str;
use Facilitador\Decoy\Models\Encoding;
use Facilitador\Decoy\Exceptions\Exception;
...
abstract class EncodingProvider
{
     ...
     *
     * @var Facilitador\Decoy\Models\Encoding
     */
    protected $model;
     ...
     * Inject dependencies
     *
     * @param Facilitador\Decoy\Models\Encoding $model
     */
