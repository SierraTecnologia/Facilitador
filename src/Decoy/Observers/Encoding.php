...
namespace Facilitador\Decoy\Observers;
...
class Encoding
{
     ...
     *    - Facilitador\Decoy\Models\Base $model
     * @return void
     */
     ...
     *
     * @param  string $event
     * @param  Facilitador\Decoy\Models\Base $model
     * @return void
     */
    ...
    public function isEncodable($model)
    {
        ...
        if (is_a($model, 'Facilitador\Decoy\Models\Element') && $model->getAttribute('type') != 'video-encoder') {
            return false;
        }
