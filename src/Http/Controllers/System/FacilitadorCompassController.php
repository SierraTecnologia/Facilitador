...
class FacilitadorCompassController extends Controller
{
    protected $request;
    ...
    public function index(Request $request)
    {
        ...
        if (!\App::environment('local') && !\Illuminate\Support\Facades\Config::get('sitec.facilitador.compass_in_production', false)) {
