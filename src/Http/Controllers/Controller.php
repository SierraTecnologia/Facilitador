...
use Facilitador\Http\Controllers\ContentTypes\Checkbox;
use Facilitador\Http\Controllers\ContentTypes\Coordinates;
use Facilitador\Http\Controllers\ContentTypes\File;
use Facilitador\Http\Controllers\ContentTypes\Image as ContentImage;
use Facilitador\Http\Controllers\ContentTypes\MultipleCheckbox;
use Facilitador\Http\Controllers\ContentTypes\MultipleImage;
use Facilitador\Http\Controllers\ContentTypes\Password;
use Facilitador\Http\Controllers\ContentTypes\Relationship;
use Facilitador\Http\Controllers\ContentTypes\SelectMultiple;
use Facilitador\Http\Controllers\ContentTypes\Text;
use Facilitador\Http\Controllers\ContentTypes\Timestamp;
...
class Controller extends BaseController
{
    ...
    {
        $database = new \Support\Coder\Discovers\Eloquent\Database();
