            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <form class="form-edit-add" role="form"
                          action="@if(isset($dataTypeContent->id)){{ \Facilitador\Routing\UrlGenerator::managerRoute($dataType->slug, 'update', $dataTypeContent->id) }}@else{{ \Facilitador\Routing\UrlGenerator::managerRoute($dataType->slug, 'store') }}@endif"
