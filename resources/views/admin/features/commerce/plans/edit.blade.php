    ...
    <div class="col-md-12 mt-4">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                {!! FormMaker::setColumns(2)->fromObject($plan, \Illuminate\Support\Facades\Config::get('commerce.forms.plans-edit')) !!}
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (is_null($customer->subscription($plan->sitecpayment_name)->ends_at))
                                        <form class="cancel-form" method="post" action="{!! url('admin/plans/'.$plan->id.'/cancel-subscription/'.$customer->id) !!}">
                                            {!! csrf_field() !!}
                                            {!! method_field('DELETE') !!}
