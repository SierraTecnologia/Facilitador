...
@section('content')
    ...
    <div class="col-md-12 mt-4">
        ...
        @include('admin.features.commerce.orders.breadcrumbs', ['location' => [['Order' => url(\Illuminate\Support\Facades\Config::get('siravel.backend-route-prefix', 'siravel').'/orders/'.$orderItem->order_id.'/edit')], 'item']])
