...
@section('content')
    ...
    <div class="col-md-12 mt-4">
        ...
        @include('admin.features.commerce.orders.breadcrumbs', ['location' => [['Order' => url(\Illuminate\Support\Facades\Config::get('cms.backend-route-prefix', 'cms').'/orders/'.$orderItem->order_id.'/edit')], 'item']])
