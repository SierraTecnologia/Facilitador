        ...
        <div class="row">
            <div class="@if (\Illuminate\Support\Facades\Config::get('siravel.live-preview', false)) col-md-6 @else col-md-12 @endif">
                {!! Form::model($page, ['route' => ['admin.pages.update', $page->id], 'method' => 'patch', 'class' => 'edit', 'files' => true]) !!}
                    ...
                    {!! FormMaker::setColumns(2)->fromObject($page->asObject(), \Illuminate\Support\Facades\Config::get('siravel.forms.page.identity')) !!}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            {!! FormMaker::setColumns(1)->fromObject($page->asObject(), \Illuminate\Support\Facades\Config::get('siravel.forms.page.content')) !!}
                        </div>
                        <div class="col-md-6">
                            @if ($page->hero_image)
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-4">
                            {!! FormMaker::setColumns(2)->fromObject($page->asObject(), \Illuminate\Support\Facades\Config::get('siravel.forms.page.seo')) !!}
                        </div>
                    </div>

                    {!! FormMaker::setColumns(2)->fromObject($page->asObject(), \Illuminate\Support\Facades\Config::get('siravel.forms.page.publish')) !!}
