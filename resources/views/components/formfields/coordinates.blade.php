...
<div id="coordinates-formfield">
    <coordinates
        ...
        :points='@json($dataTypeContent->getCoordinates() && count($dataTypeContent->getCoordinates()) ? $dataTypeContent->getCoordinates() : [[ 'lat' => config('facilitador.googlemaps.center.lat'), 'lng' => config('facilitador.googlemaps.center.lng') ]])'
