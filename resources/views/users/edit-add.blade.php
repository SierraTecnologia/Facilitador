...
@section('content')
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form"
              action="@if(!is_null($dataTypeContent->getKey())){{ route('facilitador.'.$dataType->slug.'.update', $dataTypeContent->getKey()) }}@else{{ route('facilitador.'.$dataType->slug.'.store') }}@endif"
