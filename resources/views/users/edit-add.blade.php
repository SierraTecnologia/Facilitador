...
@section('content')
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form"
              action="@if(!is_null($dataTypeContent->getKey())){{ \Facilitador\Routing\UrlGenerator($dataType->slug, 'update', $dataTypeContent->getKey()) }}@else{{ \Facilitador\Routing\UrlGenerator($dataType->slug, 'store') }}@endif"
        ...
        <form id="my_form" action="{{ route('facilitador.upload') }}" target="form_target" method="post" enctype="multipart/form-data" style="width:0px;height:0;overflow:hidden">
            {{ csrf_field() }}
