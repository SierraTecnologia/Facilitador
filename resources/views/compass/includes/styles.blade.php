<style type="text/css">
        .facilitador .compass .nav-tabs{
            background:none;
            border-bottom:0px;
        }

        .facilitador .compass .nav-tabs > li{
            margin-bottom:-1px !important;
        }

        .facilitador .compass .nav-tabs a{
            text-align: center;
            font-size: 10px;
            font-weight: normal;
            background: #f8f8f8;
        ...
        .facilitador .compass .nav-tabs a i{
            display: block;
            font-size: 22px;
        }
        ...
        #gradient_bg{
            ...
            top: 61px;
            left: 0px;
            background-image: url(/vendor/tcg/facilitador/assets/images/bg.jpg);
        ...
        .facilitador .compass .nav-tabs > li > a:hover{
        ...
        .facilitador-link span.resource_label{
            text-align: center;
            color: #fff;
            display: block;
            position: absolute;
        ...
        .facilitador-link span.resource_label:hover{
            opacity:1;
        }
        ...
        .facilitador-link span.resource_label:hover i{
            
            opacity:1;
            transition:all 0.3s linear;
        }

        .facilitador-link span.copy{
            position: absolute;
            font-size: 16px;
            left: 0px;
            bottom: 70px;
        ...
        .facilitador-angle-down{
            display:none;
        }

        .facilitador-link::after{
            content:'';
            position:absolute;
            width:100%;
            height:100%;
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#b3111111', endColorstr='#b3111117',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */
        ...
        .facilitador #logs .table>thead>tr>th:first-child{
            border-top-left-radius: 3px;
        }

        .facilitador #logs .table>thead>tr>th:last-child{
            border-top-right-radius: 3px;
        }
