(function () {
    var modern = (function (domGlobals) {
        ...
        var createToolbar = function (editor, items, size) {
            ...
            global$2.each(
                items.split(/[ ,]/), function (item) {
                    var itemName;
                    var bindSelectorChanged = function () {
                        var selection = editor.selection;
                        if (item.settings.stateSelector) {
                            selection.selectorChanged(
                                item.settings.stateSelector, function (state) {
                                    item.active(state);
                                }, true
                            );
                        }
                        if (item.settings.disabledStateSelector) {
                            selection.selectorChanged(
                                item.settings.disabledStateSelector, function (state) {
                                    item.disabled(state);
                                }
                            );
                        }
        ...
        var createToolbars = function (editor, size) {
            ...
            global$2.each(
                getToolbars(editor), function (toolbar) {
                    addToolbar(toolbar);
                }
            );
            if (toolbars.length) {
        ...
        var hideAllFloatingPanels = function (editor) {
            global$2.each(
                editor.contextToolbars, function (toolbar) {
                    if (toolbar.panel) {
                        toolbar.panel.hide();
                    }
                }
        ...
        var addContextualToolbars = function (editor) {
            ...
            var reposition = function (match, shouldShow) {
                ...
                if (relPos) {
                    ...
                    if (elementRect) {
                        relPos = global$6.findBestRelativePosition(
                            panelRect, elementRect, contentAreaRect, [
                            'bc-tc',
                            'bl-tl',
                            'br-tr'
                            ]
                ...
                togglePositionClass(
                    panel, relPos, function (pos1, pos2) {
                        return pos1 === pos2;
                    }
                );
            };
            ...
            var hideAllContextToolbars = function () {
                global$2.each(
                    getContextToolbars(), function (toolbar) {
                        if (toolbar.panel) {
                            toolbar.panel.hide();
                        }
                    }
            ...
            editor.on(
                'click keyup setContent ObjectResized', function (e) {
        ...
        var hasItemName = function (namedMenuItems, name) {
            return findIndex(
                namedMenuItems, function (namedMenuItem) {
        ...
        var cleanupMenu = function (namedMenuItems, removedMenuItems) {
            ...
            var menuItemsPass2 = filter(
                menuItemsPass1, function (namedMenuItem, i, namedMenuItems) {
                    return !isSeparator(namedMenuItem) || !isSeparator(namedMenuItems[i - 1]);
                }
            );
            return filter(
                menuItemsPass2, function (namedMenuItem, i, namedMenuItems) {
        ...
        var createMenu = function (editorMenuItems, menus, removedMenuItems, context) {
            ...
            if (menu) {
                ...
                namedMenuItems = [];
                global$2.each(
                    (menu.items || '').split(/[ ,]/), function (name) {
                ...
                if (!isUserDefined) {
                    global$2.each(
                        editorMenuItems, function (item, name) {
                ...
                menuButton.menu = map(
                    cleanupMenu(namedMenuItems, removedMenuItems), function (menuItem) {
        ...
        var createSidebar = function (editor) {
            var buttons = global$2.map(
                editor.sidebars, function (sidebar) {
        ...
        global$2.each(
            'fire on off show hide append prepend before after reflow'.split(' '), function (name) {
                proto[name] = function () {
        ...
        global$2.each(
            'text name disabled active selected checked visible parent value data'.split(' '), function (name) {
        ...
        var proto$1 = {
            ...
            init: function (settings) {
                ...
                global$2.each(
                    'title text name visible disabled active value'.split(' '), function (name) {
                        if (name in settings) {
        ...
        global$2.each(
            'text title visible disabled active value'.split(' '), function (name) {
        ...
        var Widget = Control$1.extend(
            {
                init: function (settings) {
                    ...
                    if (settings.tooltip && Widget.tooltips !== false) {
                        ...
                        self.on(
                            'mouseleave mousedown click', function () {
                                self.tooltip().remove();
                                self._tooltip = null;
                            }
                        );
        ...
        function NotificationManagerImpl(editor)
        {
            ...
            var positionNotifications = function (notifications) {
                if (notifications.length > 0) {
                    ...
                    each(
                        notifications, function (notification, index) {
                            if (index > 0) {
        ...
        var Checkbox = Widget.extend(
            {
                ...
                bindStates: function () {
                    ...
                    self.state.on(
                        'change:checked change:value', function (e) {
                            self.fire('change');
                            checked(e.value);
                        }
                    );
        ...
        var ComboBox = Widget.extend(
            {
                ...
                bindStates: function () {
                    ...
                    funcs.on(
                        self.getEl('status'), 'mouseleave', function () {
                            self.tooltip().hide();
                        }
                    );
                    self.on(
        ...
        var ColorBox = ComboBox.extend(
            {
                init: function (settings) {
                    ...
                    self.on(
                        'change keyup postrender', function () {
        ...
        var select = function (selector, root) {
            return map(
                descendants(Element.fromDom(root), selector), function (element) {
                    return element.dom();
                }
            );
        };
        ...
        var createMenuItems = function (term, targets, fileType, editorSettings) {
            ...
            var fromHistoryMenuItems = function (history) {
                ...
                var uniqueHistory = filter(
                    historyItems, function (url) {
                        return isUniqueUrl(url, targets);
                    }
                );
                return global$2.map(
                    uniqueHistory, function (url) {
                        return {
                            title: url,
                            value: {
                                title: url,
            ...
            editor.addButton(
                'align', {
                    ...
                    onShowMenu: function (e) {
                        ...
                        global$2.each(
                            alignFormats, function (formatName, idx) {
                    ...
                    onPostRender: function (e) {
                        ...
                        global$2.each(
                            alignFormats, function (formatName, idx) {
                                addFormatChangedListener(
                                    editor, formatName, function (state) {
        ...
        var getFontSizeItems = function (editor) {
            ...
            return global$2.map(
                fontsizeFormats.split(' '), function (item) {
        ...
        var trimMenuItems = function (menuItems) {
            var menuItems2 = filter(
                menuItems, function (menuItem, i, menuItems) {
                    return !isSeparator$1(menuItem) || !isSeparator$1(menuItems[i - 1]);
                }
            );
            return filter(
                menuItems2, function (menuItem, i, menuItems) {
        ...
        var createContextMenuItems = function (editor, context) {
            ...
            var menuItems = global$2.grep(
                editor.menuItems, function (menuItem) {
        ...
        var toggleUndoRedoState = function (editor, type) {
            return function () {
                ...
                editor.on(
                    'Undo Redo AddUndo TypingUndo ClearUndos SwitchMode', function () {
        ...
        var setupHideFloatPanels = function (editor) {
            editor.on(
                'mousedown progressstate', function () {
                    FloatPanel.hideAll();
                }
            );
        };
                ...
                renderHtml: function () {
                    ...
                    function markMatches(text)
                    {
                        ...
                        return match ? text.replace(
                            new RegExp(escapeRegExp(match), 'gi'), function (match) {
